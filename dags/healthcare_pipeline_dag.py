...
#     dbt_test_raw = BashOperator(
#         task_id="dbt_test_raw",
#         bash_command=f"source /usr/local/airflow/dbt_venv/bin/activate && dbt test --select source:* --target {TARGET_ENV}",
#         cwd="/usr/local/airflow/dbt/healthcare_dbt_bigquery_data_pipeline",
#     )

#     transform = BashOperator(
#         task_id="transform",
#         bash_command=f"source /usr/local/airflow/dbt_venv/bin/activate && dbt run --select path:models --target {TARGET_ENV}",
#         cwd="/usr/local/airflow/dbt/healthcare_dbt_bigquery_data_pipeline",
#     )
